...
pg_connect ADMIN $CHAT_DB "
    ...
    GRANT CONNECT ON DATABASE $CHAT_DB TO \"$PGMONITOR_USERNAME\";
    GRANT USAGE ON SCHEMA pg_catalog TO \"$PGMONITOR_USERNAME\";
    GRANT SELECT ON ALL TABLES IN SCHEMA pg_catalog TO \"$PGMONITOR_USERNAME\";
    GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO \"$PGMONITOR_USERNAME\";
    ALTER DEFAULT PRIVILEGES IN SCHEMA pg_catalog GRANT SELECT ON TABLES TO \"$PGMONITOR_USERNAME\";
    ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO \"$PGMONITOR_USERNAME\";
